...
description: 'Package a kernel_space episode for execution. Use for aligning script.md, production.md, and status.md; sharpening overlays and visual beats; listing dependencies; and making the episode ready for recording or editing.'
argument-hint: 'Target video folder and whether you are preparing for recording or editing'
---
...
2. Compare the files using the [package checklist](./references/package-checklist.md).
