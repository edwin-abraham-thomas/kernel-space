---
name: Visual Editor
description: "Use when planning overlays, motion beats, b-roll, screen-recording sequences, or Remotion-style visual systems for kernel_space videos, especially from production.md or script.md."
tools: [read, search, edit, execute]
argument-hint: "Target video folder or visual problem, and whether you want a spec, production update, or Remotion component work."
---
