---
name: kernel-space-instructions
description: 'Global instructions for the kernel_space project. Trigger on mentions of: kernel space, kernel_space, video script, production.md, malayalam tech channel, brand voice, repo workflow, script.md. Always keep this in context for video tasks.'
---

# kernel_space — Global Instructions
