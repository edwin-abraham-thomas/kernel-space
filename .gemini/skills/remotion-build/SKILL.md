---
name: remotion-build
description: 'Build or document Remotion visuals for a kernel_space episode. Trigger on mentions of: remotion, build visuals, render commands, implement motion. Use when turning production.md beats, guide.md execution notes, and artifacts.md output paths into reusable compositions, render commands, and episode-local build artifacts.'
---
